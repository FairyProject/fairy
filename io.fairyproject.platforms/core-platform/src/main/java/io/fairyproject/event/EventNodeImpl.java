...
//        }
    ...
    final class Handle<E extends Event> implements ListenerHandle<E> {
        ...
        private @Nullable Consumer<E> createConsumer() {
            ...
            final Consumer<E>[] listenersArray = listeners.toArray(new Consumer[0]);
            // Mapped
        ...
        private @Nullable Consumer<E> listenersConsumer(@NotNull ListenerEntry<E> entry) {
            final EventListener<E>[] listenersCopy = entry.listeners.toArray(new EventListener[0]);
            final Consumer<E>[] bindingsCopy = entry.bindingConsumers.toArray(new Consumer[0]);
        ...
        private @Nullable Consumer<E> mappedConsumer() {
            ...
            final EventFilter<E, ?>[] filterList = filters.toArray(new EventFilter[0]);
            ...
            switch (filterList.length) {
                case 1:
                    return event -> mapper.accept(filterList[0], event);
                case 2:
                    return event -> {
