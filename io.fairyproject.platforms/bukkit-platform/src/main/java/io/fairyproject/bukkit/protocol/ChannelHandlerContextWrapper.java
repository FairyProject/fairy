...
public class ChannelHandlerContextWrapper implements ChannelHandlerContext {
    ...
    private final BukkitByteBufProcessor processor;

    public ChannelHandlerContextWrapper(ChannelHandlerContext base, BukkitByteBufProcessor handler) {
        this.base = base;
    ...
    public boolean transform(ByteBuf buf) {
        try {
            ...
            try {
                processor.exceptionCaught(base, e);
            } catch (Exception e1) {
