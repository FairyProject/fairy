            ...
            try {
                ...
                try {
                    ...
                    // ignore
                     ...
                     io.github.toolfactory.narcissus.Narcissus.findField(this.javaClass, "delegate")?.let { field ->
                        io.github.toolfactory.narcissus.Narcissus.getField(this, field)?.let { delegate ->
                            (delegate as HttpURLConnection?)?.forceMethod(method)
                        }
                    }
                }
        ...
        (this.getSuperclasses() + this).forEach { clazz ->
            try {
                ...
                try {
                    ...
                    io.github.toolfactory.narcissus.Narcissus.findField(clazz, "delegate")?.let {
                        val item = io.github.toolfactory.narcissus.Narcissus.getField(instance, it)
                        if (item is URLConnection) {
                            return item.javaClass.getField(name, item)
                        }
                    }
                }
            }
